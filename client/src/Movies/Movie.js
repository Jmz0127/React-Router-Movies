...
//import router dom items
import { useParams } from 'react-router-dom'; //useParams = get data from a URL
  ...
  useEffect(() => {
    axios
      ...
      .then(response => {
        ...
        //ALWAYS CONSOLE.LOG YOUR RESPONSE FIRST!! THATS HOW WE KNOW TO DO .data above!
